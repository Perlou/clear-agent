...
**上下文工程**是 ClearAgent 框架的核心能力，解决长对话中的上下文爆窗、Token 成本爆炸和缓存失效问题。
...
```python
from clear_agent import Config
...
**使用示例：**
```python
from clear_agent.context import HistoryManager
...
**使用示例：**
```python
from clear_agent.context import TokenCounter
...
**使用示例：**
```python
from clear_agent.context import ObservationTruncator
...
**新增功能：**
```python
from clear_agent.core import Message
