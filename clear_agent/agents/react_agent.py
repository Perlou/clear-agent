            ...
            while current_step < self.max_steps:
                ...
                try:
                    ...
                    await self._emit_event(
                        EventType.AGENT_ERROR, on_error, error=str(e), step=current_step
                    )
                    break
                ...
                tool_results = await self._execute_tools_async(
                    tool_calls, current_step, on_tool_call
                )
        ...
        try:
            ...
            while current_step < self.max_steps:
                ...
                try:
                    ...
                    await self._emit_event(
                        EventType.AGENT_ERROR, on_error, error=error_msg
                    )
                    break
                ...
                try:
                    ...
                    # 发送步骤完成事件
                    yield StreamEvent.create(
                        StreamEventType.STEP_FINISH, self.name, step=current_step
                    )
