...
import asyncio
import time
from clear_agent.core.lifecycle import AgentEvent, EventType, ExecutionContext
...
class MockTool(Tool):
    ...
    def get_parameters(self):
        return [ToolParameter(name="query", type="string", description="查询参数")]
...
class SlowTool(Tool):
    ...
    def get_parameters(self):
        return [ToolParameter(name="data", type="string", description="数据")]
...
class TestAgentEvent:
    ...
    def test_event_creation(self):
        ...
        event = AgentEvent.create(
            EventType.AGENT_START, "test_agent", input_text="Hello"
        )
