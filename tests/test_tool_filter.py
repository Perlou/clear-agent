...
class TestCustomFilter:
    ...
    def test_whitelist_mode(self):
        """测试白名单模式"""
        filter_obj = CustomFilter(allowed=["Read", "LS", "Grep"], mode="whitelist")
    ...
    def test_blacklist_mode(self):
        """测试黑名单模式"""
        filter_obj = CustomFilter(denied=["Bash", "Terminal"], mode="blacklist")
    ...
    def test_is_allowed_whitelist(self):
        """测试白名单模式的单个工具检查"""
        filter_obj = CustomFilter(allowed=["Read", "LS"], mode="whitelist")
    ...
    def test_is_allowed_blacklist(self):
        """测试黑名单模式的单个工具检查"""
        filter_obj = CustomFilter(denied=["Bash"], mode="blacklist")
