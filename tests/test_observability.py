...
class TestTraceLogger:
    ...
    def test_log_event_creates_jsonl(self):
        ...
        # 记录事件
        logger.log_event("session_start", {"agent_name": "TestAgent", "config": {}})
        logger.log_event(
            "tool_call", {"tool_name": "Calculator", "args": {"input": "2+2"}}, step=1
        )
    ...
    def test_sanitize_api_key(self):
        ...
        logger.log_event(
            "model_output",
            {"api_key": "sk-1234567890abcdef", "auth": "Bearer token_secret_123"},
        )
    ...
    def test_stats_computation(self):
        ...
        # 记录错误
        logger.log_event(
            "error", {"error_type": "TIMEOUT", "message": "Tool timeout"}, step=2
        )
